...
inline void AddVerticalSpacing(float spacing) {
...
inline void DrawItemCategoryFilter() {
...
inline void DrawWeaponItemFilter()
{
...
inline void DrawVisualsTab() {
    ...
    SectionHeader("Player ESP", { 0.8f,0.3f,0.0f,0.7f }, [&]() {
        ...
        bool* states[] = { &Globals.ESPEnabled, &Globals.DrawBones, &Globals.DrawHeadCircle, &Globals.DrawNames, &Globals.DrawLowHP, &Globals.DrawTraceline };
    ...
    SectionHeader("ESP Colors", { 0.1f, 0.6f, 0.9f, 0.7f }, [&]() {
        ...
        const char* espItems[] = {
            ...
            "Head Circle", "Low HP", "Items", "Weapons", "FOV Circle"
        };
        ...
        case 5: ImGui::ColorEdit4("##colorwheel", (float*)&Globals.ColorLowHP, ImGuiColorEditFlags_PickerHueWheel | ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_NoLabel); break;
        case 6: ImGui::ColorEdit4("##colorwheel", (float*)&Globals.ColorItems, ImGuiColorEditFlags_PickerHueWheel | ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_NoLabel); break;
        case 7: ImGui::ColorEdit4("##colorwheel", (float*)&Globals.ColorWeapons, ImGuiColorEditFlags_PickerHueWheel | ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_NoLabel); break;
        case 8: ImGui::ColorEdit4("##colorwheel", (float*)&Globals.ColorFOV, ImGuiColorEditFlags_PickerHueWheel | ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_NoLabel); break;
        }
...
inline void DrawSettingsTab()
{
    ...
    if (ImGui::CollapsingHeader("Menu", ImGuiTreeNodeFlags_DefaultOpen)) {
        ...
        // --- Switch Monitors ---
        ImGui::Text("Switch Monitors"); ImGui::NextColumn();
        ...
        {
            set_monitor(currentMonitor, Globals.overlayHWND);
        }
        ImGui::NextColumn();

        const char* overlayModes[] = { "[1PC]Transparent", "[2PC]Fuser" };
        if (ImGui::Combo("Overlay Mode", &Globals.overlayMode, overlayModes, IM_ARRAYSIZE(overlayModes)))
        {
            bool enableGlass = (Globals.overlayMode == 0);
            EnableGlassTransparency(Globals.overlayHWND , enableGlass);
        }
        ImGui::NextColumn();
    ...
    }
    {
        ...
        {
			//lets use some nice default colors
...
inline void DrawAimbotTab()
{
    ...
    ImGui::Text("Ignore Knocked"); ImGui::NextColumn(); ImGui::Checkbox("##AimbotEnable", &Globals.settings.IgnoreKnocked); ImGui::NextColumn();
    ImGui::Columns(1);
    ImGui::Spacing();
